...
Coala is a python tool that translates BC into ASP facts.<br>
For earlier versions for other action language see <a href="#legacy">Legacy</a><br>
...
Alternatively, it can be run directly from the unpacked folder using python<br>
