...
Get the most recent Version from Github.<br>
You can either download the whole project or a packed version from the dist directory.
<a href="https://github.com/potassco/coala">https://github.com/potassco/coala<br>
...
```
If you don't want to install it, coala can be run directly from the project folder using python
```
    python coala/coala
```
